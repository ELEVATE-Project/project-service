...
let solutionData = [
	...
	},
	{
		...
		description: 'To capture user feedback and field insights on implementation effectiveness.',
		author: '3',
	...
	},
	{
		...
		externalId: 'fb34d196-a8fe-11f0-9793-553f35f97dd1-OBSERVATION-TEMPLATE-1760447411986',
		isReusable: false,
		...
		evidences: [
			...
			},
			{
				...
				sections: [
					{
						code: 'SEC2',
						questions: [new ObjectId('691c1b17266ef5649ce41039'), new ObjectId('691c1b17266ef5649ce4103a')],
					},
				],
			},
		],
...
let criteriaQuestionsData = [
				...
				sections: [
					{
						...
						questions: [
							...
							},
							{
								...
								question: ['What resources do you refer to while preparing science lessons?', ''],
								tip: '',
								hint: '',
								responseType: 'multiselect',
								value: '',
							...
							},
							{
								...
								question: ['Which type of science activities do you use most often in class?', ''],
								tip: '',
								hint: '',
								responseType: 'multiselect',
								value: '',
							...
							},
							{
								...
								question: ['What challenges do you face in implementing these activities?', ''],
								tip: '',
								hint: '',
								responseType: 'multiselect',
								value: '',
	...
	},
	{
		_id: new ObjectId('691ac8ae1ce3f5956e9f21f6'),
		externalId: 'SUR_TEST_001_1763362989477-1763362990232',
		question: ['How often do you use structured lesson plans to teach science concepts?', ''],
		tip: '',
		hint: '',
		responseType: 'radio',
		value: '',
	...
	},
	{
		_id: new ObjectId('691ac8ae1ce3f5956e9f21f9'),
		externalId: 'SUR_TEST_004_1763362989477-1763362990236',
		question: ['How confident are you in using project-based or activity-based methods to teach science?', ''],
		tip: '',
		hint: '',
		responseType: 'radio',
		value: '',
	...
	},
	{
		_id: new ObjectId('691ac8ae1ce3f5956e9f21fb'),
		externalId: 'SUR_TEST_006_1763362989477-1763362990237',
		question: ['To what extent do students participate in science-based activities and model creation?', ''],
		tip: '',
		hint: '',
		responseType: 'radio',
		value: '',
	...
	},
	{
		_id: new ObjectId('691ac8ae1ce3f5956e9f21fc'),
		externalId: 'SUR_TEST_007_1763362989477-1763362990238',
		question: ['What improvement have you noticed in student understanding through these lesson plans?', ''],
		tip: '',
		hint: '',
		responseType: 'radio',
		value: '',
...
let questionsData = [
	...
	},
	{
		_id: new ObjectId('691b17ae1ce3f5956e9f3187'),
		externalId: 'Q3_1763383206243-1763383214134',
		question: ['Has the teacher received any orientation/training on Project-Based Learning (PBL)?', ''],
		tip: '',
		hint: '',
		responseType: 'radio',
		value: '',
	...
	},
	{
		_id: new ObjectId('691b17ae1ce3f5956e9f3188'),
		externalId: 'Q4_1763383206243-1763383214134',
		question: ['Does the teacher clearly explain the scientific concept during the class?', ''],
		tip: '',
		hint: '',
		responseType: 'radio',
		value: '',
	...
	},
	{
		_id: new ObjectId('691b17ae1ce3f5956e9f3189'),
		externalId: 'Q5_1763383206243-1763383214135',
		question: ['Is there sufficient teaching-learning material available in the classroom?', ''],
		tip: '',
		hint: '',
		responseType: 'radio',
		value: '',
	...
	},
	{
		_id: new ObjectId('691b17ae1ce3f5956e9f318a'),
		externalId: 'Q6_1763383206243-1763383214135',
		question: ['Does the school have a science lab or a dedicated space for displaying models?', ''],
		tip: '',
		hint: '',
		responseType: 'radio',
		value: '',
	...
	},
	{
		_id: new ObjectId('691b17ae1ce3f5956e9f318b'),
		externalId: 'Q7_1763383206243-1763383214136',
		question: ['Which digital platforms do students have access to for science learning?', ''],
		tip: '',
		hint: '',
		responseType: 'multiselect',
		value: '',
	...
	},
	{
		_id: new ObjectId('691b17ae1ce3f5956e9f318d'),
		externalId: 'Q9_1763383206243-1763383214137',
		question: ['Are students actively participating in classroom discussions or science-related activities?', ''],
		tip: '',
		hint: '',
		responseType: 'radio',
		value: '',
...
let observationData = [
			...
			organizations: [
				{
					...
					name: 'Bengaluru',
					code: 'blr',
					description: 'Bengaluru is the capital of Indias southern Karnataka state.',
					status: 'ACTIVE',
					related_orgs: null,
					tenant_code: 'shikshagraha',
					meta: {
	...
	},
	{
		...
		programId: new ObjectId('68ee4b79fb9bee08b93b6d34'),
		programExternalId: 'Survey_Program_newmay_14_2245',
		solutionExternalId: 'fb34d196-a8fe-11f0-9793-553f35f97dd1-OBSERVATION-TEMPLATE-1760447411986',
...
let observationSubmissionData = [
	{
		...
		programInformation: {
			...
			metaInformation: {
				state: ['Tripura'],
				recommendedFor: ['student', 'sh', 'teacher', 'functionaries-officials'],
			},
			tenantId: 'default',
			orgId: 'default_code',
