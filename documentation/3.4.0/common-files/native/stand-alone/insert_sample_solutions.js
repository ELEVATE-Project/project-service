...
async function main({ dataToBeInserted }) {
	...
	console.log(`\n=================================================`)
	console.log(
		`🗑️ Starting CLEANUP for ${dataToBeInserted === entityData ? 'Entity Data' : 'Project Data'} Collections...`
	)
	console.log(`=================================================`)
	...
	console.log(`\n=================================================`)
	console.log(
		`➕ Starting INSERTION for ${dataToBeInserted === entityData ? 'Entity Data' : 'Project Data'} Collections...`
	)
	console.log(`=================================================`)
