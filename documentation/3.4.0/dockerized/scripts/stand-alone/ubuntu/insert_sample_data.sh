...
psql -h localhost -p 5432 -U postgres -d user -c "INSERT INTO public.user_organizations (user_id,organization_code, tenant_code, created_at, updated_at, deleted_at) VALUES (1, 'default_code', 'default', '2024-04-18 08:12:19.394+00', '2024-04-18 08:12:19.394+00', NULL);"
psql -h localhost -p 5432 -U postgres -d user -c "INSERT INTO public.user_organizations (user_id,organization_code, tenant_code, created_at, updated_at, deleted_at) VALUES (2, 'default_code', 'default', '2024-04-18 08:12:19.394+00', '2024-04-18 08:12:19.394+00', NULL);"
psql -h localhost -p 5432 -U postgres -d user -c "INSERT INTO public.user_organizations (user_id,organization_code, tenant_code, created_at, updated_at, deleted_at) VALUES (3, 'default_code', 'default', '2024-04-18 08:12:19.394+00', '2024-04-18 08:12:19.394+00', NULL);"
psql -h localhost -p 5432 -U postgres -d user -c "INSERT INTO public.user_organizations (user_id,organization_code, tenant_code, created_at, updated_at, deleted_at) VALUES (4, 'default_code', 'default', '2024-04-18 08:12:19.394+00', '2024-04-18 08:12:19.394+00', NULL);"

# --- 3. INSERT INTO public.user_organization_roles ---
# FIXES:
# - Quoted the organization_code and tenant_code variables.
...
# --- 5. UPDATES and SEQUENCES ---
psql -h localhost -p 5432 -U postgres -d user -c "UPDATE public.entity_types SET status = 'INACTIVE' WHERE id = 3;"
psql -h localhost -p 5432 -U postgres -d user -c "SELECT nextval('users_id_seq'::regclass) FROM public.users;"
psql -h localhost -p 5432 -U postgres -d user -c "SELECT nextval('users_credentials_id_seq'::regclass) FROM public.users_credentials;"
psql -h localhost -p 5432 -U postgres -d user -c "SELECT NULL;"
