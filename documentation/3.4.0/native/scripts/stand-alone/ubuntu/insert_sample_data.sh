...
sudo -u postgres psql -p 5432 -d users -c "INSERT INTO public.user_roles (id, title, tenant_code, created_at, updated_at) VALUES (1, 'admin', 'default', NOW(), NOW()) ON CONFLICT (id, tenant_code) DO NOTHING;"
sudo -u postgres psql -p 5432 -d users -c "INSERT INTO public.user_roles (id, title, tenant_code, created_at, updated_at) VALUES (8, 'state_education_officer', 'default', NOW(), NOW()) ON CONFLICT (id, tenant_code) DO NOTHING;"
...
sudo -u postgres psql -p 5432 -d users -c "INSERT INTO public.user_organization_roles (tenant_code, user_id, organization_code,role_id, created_at, updated_at, deleted_at) VALUES ('default', 3, 'default_code', 8, '2024-04-18 08:12:19.394+00', '2024-04-18 08:12:19.394+00', NULL);"
sudo -u postgres psql -p 5432 -d users -c "INSERT INTO public.user_organization_roles (tenant_code, user_id, organization_code,role_id, created_at, updated_at, deleted_at) VALUES ('default', 2, 'default_code', 8, '2024-04-18 08:12:19.394+00', '2024-04-18 08:12:19.394+00', NULL);"
sudo -u postgres psql -p 5432 -d users -c "INSERT INTO public.user_organization_roles (tenant_code, user_id, organization_code,role_id, created_at, updated_at, deleted_at) VALUES ('default', 4, 'default_code', 8, '2024-04-18 08:12:19.394+00', '2024-04-18 08:12:19.394+00', NULL);"


# --- 5. INSERT INTO public.entity_types ---
# FIX: Added 'tenant_code' to the columns list and provided the value 'default'.
sudo -u postgres psql -p 5432 -d users -c "INSERT INTO public.entity_types (id, value, label, status, created_by, updated_by, allow_filtering, data_type, organization_id, parent_id, has_entities, allow_custom_entities, model_names, created_at, updated_at, deleted_at, meta, external_entity_type, required, regex, tenant_code) VALUES (4, 'state', 'State', 'ACTIVE', 0, 0, true, 'STRING', 1, NULL, true, true, '{User}', '2024-04-18 08:12:19.394+00', '2024-04-18 08:12:19.394+00', NULL, NULL, true, false, NULL, 'default');"
