...
module.exports = {
	...
	// Program Users API Responses
	PROGRAM_USER_CREATED: 'Program user created successfully',
	PROGRAM_USER_NOT_CREATED: 'Failed to create program user',
	PROGRAM_USER_UPDATED: 'Program user updated successfully',
	PROGRAM_USER_NOT_UPDATED: 'Failed to update program user',
	PROGRAM_USER_FETCHED: 'Program user fetched successfully',
	PROGRAM_USER_NOT_FOUND: 'Program user not found',
	PROGRAM_USER_DELETED: 'Program user deleted successfully',
	PROGRAM_USER_NOT_DELETED: 'Failed to delete program user',
	PROGRAM_USERS_FETCHED: 'Program users fetched successfully',
	PROGRAM_USER_ALREADY_EXISTS: 'User already exists in this program',
	...
	PROGRAM_USER_METADATA_UPDATED: 'Program user metadata updated successfully',
	PROGRAM_USER_METADATA_NOT_UPDATED: 'Failed to update program user metadata',
	STATUS_FLOW_FETCHED: 'Status flow fetched successfully',
	MOCK_DATA_GENERATED: 'Mock data generated successfully',
