...
module.exports = class LibraryCategoriesHelper {
	...
	static projects(categoryId, pageSize, pageNo, search, sortedData, language = 'en', hasSpotlight = false) {
				...
				aggregateData.push(
					{
						$project: {
							title: {
								$ifNull: [`$translation.${language}.title`, '$title'],
							},
							description: {
								$ifNull: [`$translation.${language}.description`, '$description'],
							},
							impact: {
								$ifNull: [`$translation.${language}.impact`, '$impact'],
							},
							summary: {
								$ifNull: [`$translation.${language}.summary`, '$summary'],
							},
							story: {
								$ifNull: [`$translation.${language}.story`, '$story'],
							},
							externalId: 1,
							noOfRatings: 1,
							averageRating: 1,
